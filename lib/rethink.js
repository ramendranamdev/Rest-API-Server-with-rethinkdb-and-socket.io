...
.then(function (connection) {
    ...
    module.exports.save = function (tableName, object) {
        return rdb.table(tableName).insert(object, {returnChanges: true}).run(connection)
        .then(function (result) {
            return result;
        });
    };
    ...
    module.exports.edit = function (tableName, id, object) {
        return rdb.table(tableName).get(id).update(object, {returnChanges: true}).run(connection)
        .then(function (result) {
            return result;
        });
    };
